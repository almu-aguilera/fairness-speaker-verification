...
class SpeakerNet(nn.Module):
    ...
    def forward(self, data, label=None):
        ...
        ##En esta Linea el output es la prediccion que obtenemos, puede ser mejor o peor
        ##pero es la estimacion obtenida (que si es tal o cual)
        ...
        if label == None:
            ...
            ##En esta por el contrairo, sacamos  cuánto se equivoca la red al realizar predicciones (nloss).
            ##Cuanto más próximo a cero es el valor de coste, mejor son las predicciones de la red
